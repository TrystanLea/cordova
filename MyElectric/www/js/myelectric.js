...
{
    cordova.plugin.http.get('https://emoncms.org/feed/list.json', {
        userid: '22522'
    }, { }, function(response) {
    
        feeds_in = JSON.parse(response.data)
...
function powergraph_load() 
{
    ...
    cordova.plugin.http.get('https://emoncms.org/feed/data.json', {
        id: '166913',
        start: ''+start,
        end: ''+end,
        interval: ''+interval,
...
{   
    ...
    cordova.plugin.http.get('https://emoncms.org/feed/data.json', {
        ...
        var elec_result = JSON.parse(response.data);
